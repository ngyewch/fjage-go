...
type Gateway interface {
	...
	Subscribe(ctx context.Context, agentID string) (*MessageSubscription[fjage.IMessage], error)
	RegisterMessageType(clazz string, instantiator func() fjage.IMessage)
}
